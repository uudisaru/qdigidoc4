...
void AddRecipients::init()
{
	...
	connect( ui->confirm, &ColoredButton::clicked, this, &AddRecipients::accept );
	connect( ui->cancel, &ColoredButton::clicked, this, &AddRecipients::reject );
	...
	ui->cancel->init(ColoredButton::Red);
	ui->confirm->init(ColoredButton::Main);
}
